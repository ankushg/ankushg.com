...
import stage1 from "@/images/posts/quizlet-shared-kotlin/stage1.png"
import stage2 from "@/images/posts/quizlet-shared-kotlin/stage2.png"
import stage3 from "@/images/posts/quizlet-shared-kotlin/stage3.png"
import stage4 from "@/images/posts/quizlet-shared-kotlin/stage4.png"
import stage5 from "@/images/posts/quizlet-shared-kotlin/stage5.png"
import stage6 from "@/images/posts/quizlet-shared-kotlin/stage6.png"
import kmppModel from "@/images/posts/quizlet-shared-kotlin/kmpp-model.png"
...
<Figure imageSrc={stage1} caption="Simple Web Client + API" />

to this:

<Figure imageSrc={stage2} caption="Complex Web Client + API" />
...
<Figure imageSrc={stage3} caption="Complex Web Client… Brand-New Mobile Clients" />
...
<Figure imageSrc={stage4} caption="Simple Web and Mobile Clients with Secret Sauce behind the API" />
...
<Figure imageSrc={stage5} caption="JS Artifacts in Mobile Clients" />
...
<Figure imageSrc={kmppModel} caption="Kotlin Multiplatform’s Compiler Framework" />
...
<Figure imageSrc={stage6} caption="Kotlin Multiplatform’s Promised Interaction" />
