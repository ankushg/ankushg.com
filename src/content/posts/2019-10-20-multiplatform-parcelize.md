...
description: Using Platform-Specific Declarations to unlock `@Parcelize` in [Kotlin Multiplatform](https://www.jetbrains.com/lp/mobilecrossplatform/) Projects
categories:
  - posts
feature: true
tags:
...
header:
  ...
  actions:
    - label: 'GitHub'
      ...
      icon: 'fe:github'
date: 2019-10-20
permalink: /posts/multiplatform-parcelize
---
