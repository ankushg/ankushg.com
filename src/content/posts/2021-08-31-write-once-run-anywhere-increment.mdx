...
description: I wrote an [article](https://increment.com/mobile/write-once-run-anywhere/) for [Increment Magazine's Mobile edition](https://increment.com/mobile/), sharing lessons about the nuances of cross-platform development. Published in print and digital!
...
read_time: false
date: 2021-08-31
slug: write-once-run-anywhere-increment
---
