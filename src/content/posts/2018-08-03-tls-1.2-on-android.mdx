...
date: 2018-08-03
slug: tls-1.2-on-android
---
import bugdroidImage from "@/images/posts/tls-1.2-bugdroid.png"

<Figure imageSrc={bugdroidImage} caption="The Android robot is reproduced or modified from work created and shared by Google and used according to terms described in the Creative Commons 3.0 Attribution License" />
...
{/* <Gist id="034c151ac6ed4ed5c89d3065e2899149" filename="InstallTls12.kt" /> */}
```kotlin
...
{/* <Gist id="88140bc973a1348b789064c926f0ad10" filename="QuizletGlideModule.kt" /> */}
