...
header:
  ...
  actions:
    - label: 'GitHub'
      ...
      icon: 'fe:github'
date: 2019-10-20
slug: multiplatform-parcelize
---

import parcelsImage from "@/images/posts/parcels.jpg"
...
<Figure imageSrc={parcelsImage} caption="Photo by [Joanna Kosinska](https://unsplash.com/photos/B6yDtYs2IgY)"/>
